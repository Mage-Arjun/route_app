...
class AppTheme {
  ...
  // ── Glass decoration ─────────────────────────────────────
  static BoxDecoration glassCard({double radius = 16, Color? border}) =>
      BoxDecoration(
        color: bgGlass,
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      bottomSheetTheme: const BottomSheetThemeData(backgroundColor: bgCard),
  ...
  static ThemeData get driverTheme => darkTheme;

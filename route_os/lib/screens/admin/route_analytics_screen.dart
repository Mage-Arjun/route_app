...
class RouteAnalyticsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RouteAnalyticsScreen> createState() =>
      _RouteAnalyticsScreenState();
}
          ...
          : RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _statCard(
                    'Avg Completion',
                    '${(_data!['avg_completion_rate'] ?? 0).toStringAsFixed(1)}%',
                    Icons.check_circle,
                    AppTheme.success,
                  ),
                  _statCard(
                    'Avg Distance',
                    '${(_data!['avg_distance_km'] ?? 0).toStringAsFixed(1)} km',
                    Icons.straighten,
                    AppTheme.info,
                  ),
                  _statCard(
                  ...
                  ...(_data!['recent_trips'] as List? ?? []).map(
                    (trip) => Card(
                      child: ListTile(
                        title: Text(
                          '${trip['date']}',
                        ...
                        subtitle: Text(
                          '${trip['completed_stops']}/${trip['total_stops']} stops completed',
                        ),
                        trailing: Container(

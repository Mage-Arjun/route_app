...
class ApiConfig {
  // Default to localhost:8000 (works automatically via USB with `adb reverse tcp:8000 tcp:8000`)
  // Falls back to LAN IP if on local WiFi
  static const String defaultBaseUrl = 'http://localhost:8000';
  static const String fallbackLanUrl = 'http://10.123.8.209:8000';

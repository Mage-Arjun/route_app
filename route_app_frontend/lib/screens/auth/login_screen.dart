              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _presetChip('📶 LAN WiFi (10.123.8.209)', ApiConfig.fallbackLanUrl, urlCtrl, setModalState, () => testPing(ApiConfig.fallbackLanUrl)),
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, __) => Container(
        ...
        child: const Icon(Icons.route_rounded, size: 40, color: Color(0xFF0A0D14)),
      ),
    );
  }
}
